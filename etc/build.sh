...
MVN_PROFILES="ApacheHttpClient,HibernateValidator,RESTEasy,Jackson,JWT,ReactiveStreams,AWS,Ehcache,Caffeine,JDBC-CP-Hikari,JPA-EclipseLink,MySQL,OAuth2"
echo ${GREEN}
echo -e "######################################################################################"
