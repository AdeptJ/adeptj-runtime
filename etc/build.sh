...
MVN_PROFILES="jdk11+,no-shade,ApacheHttpClient,HibernateValidator,RESTEasy,Jackson,JWT,ReactiveStreams,JDBC-CP-Hikari,JPA-EclipseLink,MySQL,OAuth2,Email,Jansi,MongoDB,javax-json"
echo "${GREEN}"
echo -e "########################################################################################################################################"
