...
MVN_PROFILES="jdk11+,no-shade,HibernateValidator,RESTEasy,Jackson,JWT,ReactiveStreams,JDBC-CP-Hikari,JPA-EclipseLink,MySQL,OAuth2,Email,MongoDB,Cache,Jakarta-Json"
echo "${GREEN}"
echo -e "########################################################################################################################################"
